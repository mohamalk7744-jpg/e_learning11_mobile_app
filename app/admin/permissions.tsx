...
import { StyleSheet, ScrollView, Pressable, ActivityIndicator, Alert, View, Modal, FlatList } from "react-native";
      ...
      <Modal visible={showStudentPicker} animationType="fade" transparent>
        <View style={styles.modalContainer}>
          <ThemedView style={styles.pickerContent}>
            ...
            />
            <Pressable onPress={() => setShowStudentPicker(false)} style={styles.closePicker}>
